...
namespace syncd
{
    class RedisClient
    {
        ...
        public:
            ...
            void clearLaneMap(
                    _In_ otai_object_id_t switchVid) const;
            ...
            std::map<otai_object_id_t, swss::TableDump> getAsicView();

            std::map<otai_object_id_t, swss::TableDump> getTempAsicView();
            ...
            void processFlushEvent(
                    _In_ otai_object_id_t switchVid,
                    _In_ otai_object_id_t portVid,
                    _In_ otai_object_id_t bvId,
                    _In_ otai_fdb_flush_entry_type_t type);
