    ...
    _In_ const std::string &data)
{
    ...
    if (!m_translator->tryTranslateRidToVid(switch_id, switch_id))
    {
    ...
    _In_ const std::string &data)
{
    ...
    if (!m_translator->tryTranslateRidToVid(macsec_id, macsec_id))
    {
    ...
    SWSS_LOG_NOTICE("Sent MACSec POST status notificaiton: macsec oid %s, status %s",
