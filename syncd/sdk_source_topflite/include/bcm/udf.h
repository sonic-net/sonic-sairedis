...
typedef enum bcm_udf_abstract_pkt_format_e {
    ...
    bcmUdfAbstractPktFormatUdpUnknownL5WithoutExtnHdr = 107, /* To extract Unknown L5 payload fields,
                                           ...
                                           extension header. */
    bcmUdfAbstractPktFormatInnerUdpBfdWithoutExtnHdr = 108, /* Start of first byte of Inner UDP
                                           Header Without Extension header. */
    bcmUdfAbstractPktFormatL2Cntag = 109, /* Start of first byte of L2 Cntag */
    bcmUdfAbstractPktFormatArp = 110,   /* Start of first byte of ARP */
    bcmUdfAbstractPktFormatIpv6HdrAuthExt1 = 111, /* Start of first byte of IPv6
                                           Authentication first extension header */
    bcmUdfAbstractPktFormatIpv6HdrAuthExt2 = 112, /* Start of first byte of IPv6
                                           Authentication second extension
                                           header */
    bcmUdfAbstractPktFormatL2EtherType = 113, /* Start of first byte of L2 Ethertype */
    bcmUdfAbstractPktFormatL3Ipv6HdrFragExt1 = 114, /* Start of first byte of L3 IPV4
                                           Fragmented first extension header */
    bcmUdfAbstractPktFormatL3Ipv6HdrFragExt2 = 115, /* Start of first byte of L3 IPV4
                                           Fragmented second extension header */
    bcmUdfAbstractPktFormatGpe = 116,   /* Start of first byte of GPE header */
    bcmUdfAbstractPktFormatGre = 117,   /* Start of first byte of Gre Header */
    bcmUdfAbstractPktFormatGreWithChecksum = 118, /* Start of first byte of Gre Header
                                           with Checksum flag */
    bcmUdfAbstractPktFormatGreWithSequence = 119, /* Start of first byte of GRE Header
                                           with Sequence flag */
    bcmUdfAbstractPktFormatIcmp = 120,  /* Start of first byte of ICMP header */
    bcmUdfAbstractPktFormatIgmp = 121,  /* Start of first byte of IGMP header */
    bcmUdfAbstractPktFormatL3Ipv4 = 122, /* Start of first byte of L3 IPv4 Header */
    bcmUdfAbstractPktFormatMplsAch = 123, /* Start of first byte of MPLS Ach */
    bcmUdfAbstractPktFormatMplsCw = 124, /* Start of first byte of MPLS Control
                                           word */
    bcmUdfAbstractPktFormatKnownL3MplsFiveLabel = 125, /* Start of first byte of Mpls with five
                                           labels */
    bcmUdfAbstractPktFormatKnownL3MplsSixLabel = 126, /* Start of first byte of Mpls with six
                                           labels */
    bcmUdfAbstractPktFormatKnownL3MplsSevenLabel = 127, /* Start of first byte of Mpls with
                                           seven labels */
    bcmUdfAbstractPktFormatRarp = 128,  /* Start of first byte of RARP */
    bcmUdfAbstractPktFormatL3RoutExt1 = 129, /* Start of first byte of L3 Route First
                                           Extension Header */
    bcmUdfAbstractPktFormatL3RoutExt2 = 130, /* Start of first byte of L3 Route
                                           Second Extension Header */
    bcmUdfAbstractPktFormatL4Tcp = 131, /* Start of first byte of L4 TCP header */
    bcmUdfAbstractPktFormatL4Udp = 132, /* Start of first byte of L4 UDF header */
    bcmUdfAbstractPktFormatUnknownL5 = 133, /* Start of first byte of Unknown L5
                                           header */
    bcmUdfAbstractPktFormatInnerL2Cntag = 134, /* Start of first byte of Inner L2 CNTAG */
    bcmUdfAbstractPktFormatInnerL2Etag = 135, /* Start of first byte of Inner L2 Etag */
    bcmUdfAbstractPktFormatInnerL2 = 136, /* Start of first byte of Inner L2
                                           Header */
    bcmUdfAbstractPktFormatInnerL2Vntag = 137, /* Start of first byte of Inner L2 VNTAG */
    bcmUdfAbstractPktFormatInnerArp = 138, /* Start of first byte of Inner ARP */
    ...
    bcmUdfAbstractPktFormatInnerRarp = 146, /* Start of first byte of Inner RARP */
    bcmUdfAbstractPktFormatInnerL4Tcp = 147, /* Start of first byte of Inner L4 TCP
                                           header */
    bcmUdfAbstractPktFormatInnerL4Udp = 148, /* Start of first byte of Inner L4 UDP
                                           header */
    bcmUdfAbstractPktFormatInnerUnknownL5 = 149, /* Start of first byte of Inner Unknown
                                           L5 header */
    bcmUdfAbstractPktFormatIfaUdp = 150, /* Start of first byte of UDP IFA header */
    bcmUdfAbstractPktFormatIfaTcp = 151, /* Start of first byte of TCP IFA header */
    bcmUdfAbstractPktFormatNshOverL2 = 152, /* Start of first byte of NSH header */
    ...
    bcmUdfAbstractPktFormatGreHdrOfFourBytes = 155, /* Start of first byte of L4 header for
                                           GRE packets with 4 bytes header size */
    bcmUdfAbstractPktFormatGreHdrOfEightBytes = 156, /* Start of first byte of L4 header for
                                           GRE packets with 8 bytes header size */
    bcmUdfAbstractPktFormatGreHdrOfTwelveBytes = 157, /* Start of first byte of L4 header for
                                           GRE packets with 12 bytes header size */
    bcmUdfAbstractPktFormatGreHdrOfSixteenBytes = 158, /* Start of first byte of L4 header for
                                           GRE packets with 16 bytes header size */
    bcmUdfAbstractPktFormatGreHdrOfTwentyBytes = 159, /* Start of first byte of L4 header for
                                           GRE packets with 20 bytes header size */
    bcmUdfAbstractPktFormatL2GreHdrOfFourBytes = 160, /* Start of first byte of L4 header for
                                           L2-GRE packets with 4 bytes header
                                           size */
    bcmUdfAbstractPktFormatL2GreHdrOfEightBytes = 161, /* Start of first byte of L4 header for
                                           L2-GRE packets with 8 bytes header
                                           size */
    bcmUdfAbstractPktFormatL2GreHdrOfTwelveBytes = 162, /* Start of first byte of L4 header for
                                           L2-GRE packets with 12 bytes header
                                           size */
    bcmUdfAbstractPktFormatL2GreHdrOfSixteenBytes = 163, /* Start of first byte of L4 header for
                                           L2-GRE packets with 16 bytes header
                                           size */
    bcmUdfAbstractPktFormatL2GreHdrOfTwentyBytes = 164, /* Start of first byte of L4 header for
                                           L2-GRE packets with 20 bytes header
                                           size */
    bcmUdfAbstractPktFormatInnerUdpUnknownL5WithoutExtnHdr = 165, /* To extract Unknown L5 payload fields,
                                           ...
                                           without extension header. */
    bcmUdfAbstractPktFormatInnerUdp1588WithoutExtnHdr = 166, /* Start of first byte of inner UDP
                                           Header Without Extension header. */
    bcmUdfAbstractPktFormatL2Svtag = 167, /* Start of first byte of L2 svtag. */
    bcmUdfAbstractPktFormatRecircleHdr = 168, /* Start of first byte of EP NIH header. */
    bcmUdfAbstractPktFormatLastCount = 169 /* Unused. Always last in the list */
...
typedef enum bcm_udf_pkt_base_offset_e {
    ...
    bcmUdfPktBaseOffsetStartOfNsh = 16, /* Base offset from the start of NSH
                                           Header. */
    bcmUdfPktBaseOffsetLastCount = 17   /* Unused. Always last in the list */
...
typedef enum bcm_udf_pkt_format_action_e {
    ...
    bcmUdfPktFormatActionCount = 2      /* Unused. Always last in the list */
