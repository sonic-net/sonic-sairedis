/*
 * $Id: sw_state_res_bitmap.h,v 1.5 Broadcom SDK $
...
#ifndef _SW_STATE_RES_BITMAP_H_
#define _SW_STATE_RES_BITMAP_H_
 ...
 */
#define SW_STATE_RES_BITMAP_ALLOC_WITH_ID      0x00000001
#define SW_STATE_RES_BITMAP_ALLOC_ALIGN_ZERO   0x00000002
#define SW_STATE_RES_BITMAP_ALLOC_REPLACE      0x00000004
#define SW_STATE_RES_BITMAP_ALLOC_CHECK_ONLY   0x00000010      

typedef struct _sw_state_res_bitmap_list_s {
    int low;
    int count;
    int used;
    int lastFree;
...
} _sw_state_res_bitmap_list_t;

typedef uint32 sw_state_res_bitmap_handle_t;
...
/*
 *   Function
 *      sw_state_res_bitmap_alloc_align
 *   Purpose
 *      Allocate an element or block of elements of a particular resource,
...
/*
 *   Function
 *      sw_state_res_bitmap_alloc_align_sparse
 *   Purpose
 ...
 *      sw_state_res_bitmap_free_sparse function.
 */
extern int
 ...
 *      sw_state_res_bitmap_alloc_align_sparse function.
 */
extern int
...
/*
 *   Function
 *      sw_state_res_bitmap_free_sparse
 *   Purpose
 ...
 *
 *      Anything allocated with sw_state_res_bitmap_alloc_align_sparse must be freed
...
/*
 *   Function
 *      sw_state_res_bitmap_check_all_sparse
 *   Purpose
...
#endif /* ndef _SW_STATE_RES_BITMAP_H_ */
