...
#define SOC_TD3_FP_SLICE_ENTRY_NARROW_VIEW(_u_) (SOC_IS_HURRICANE4(_u_) ? 2048 : \
                                                 SOC_IS_HELIX5(_u_) ? 1024 : \
                                                 1536)
#define SOC_TD3_FP_SLICE_ENTRY_WIDE_VIEW(_u_)   (SOC_IS_HURRICANE4(_u_) ? 1024 : \
                                                 SOC_IS_HELIX5(_u_) ? 512 : \
                                                 768)
...
extern uint32 soc_td3_bsk_hs_fifo_bmask[SOC_MAX_NUM_DEVICES][2];
...
extern int soc_td3_ports_per_pm_get(int unit, int pm_id);
...
extern int soc_trident3_l3_memwr_parity_check(int unit, soc_mem_t mem,
                                              int disable);
extern int soc_td3_ser_single_bit_report_for_bus_buf_set(int unit, int enable);
...
extern int
soc_trident3_ser_enable_special_table(int unit);
...
extern int soc_td3_ifp_tcam_dma_read(int unit, soc_mem_t mem, int blk, uint32 *table,
...
enum td3_vlxlt_hash_key_type_e {
    ...
    TD3_VLXLT_HASH_KEY_TYPE_MIM_BMACSA_BVID_ISID = 23,
...
enum td3_evlxlt_hash_key_type_e {
    ...
    TD3_ELVXLT_HASH_KEY_TYPE_DVP_VFI_ASSIGN_ISID = 13,
    TD3_ELVXLT_HASH_KEY_TYPE_CHANGE_L2_FIELDS = 17,
    TD3_ELVXLT_1_HASH_KEY_TYPE_DGPP_OVID_IVID = 17,
    TD3_ELVXLT_HASH_KEY_TYPE_ERSPAN3_VXLAN_MIRROR = 20,
    TD3_ELVXLT_HASH_KEY_TYPE_LS_NAT_L3UC_SNAT = 22,
    TD3_ELVXLT_HASH_KEY_TYPE_LS_NAT_L3MC = 23,
    TD3_ELVXLT_HASH_KEY_TYPE_LS_NAT_L3UC_DNAT = 24,
    TD3_ELVXLT_1_HASH_KEY_TYPE_IFA_MD_LOOKUP_2 = 26,
    TD3_ELVXLT_1_HASH_KEY_TYPE_IFA_MD_LOOKUP_1 = 27,
    TD3_ELVXLT_2_HASH_KEY_TYPE_IFA_MD_LOOKUP_2 = 28,
    TD3_ELVXLT_2_HASH_KEY_TYPE_IFA_MD_LOOKUP_1 = 29,
...
#define _TD3_THDI_BUFFER_CELL_LIMIT_SP_MAX           _TD3_MMU_TOTAL_CELLS
#define _TD3_THDI_HDRM_BUFFER_CELL_LIMIT_HP_MAX      _TD3_MMU_TOTAL_CELLS
...
typedef enum {
    ...
    _SOC_TD3_PARITY_TYPE_MACSEC_SER,
    _SOC_TD3_PARITY_TYPE_MACSEC_FUNCTIONAL,
#endif
    _SOC_TD3_PARITY_TYPE_COUNT /* Always Last. Not a usable value. */
...
extern int soc_td3_cosq_threshold_dynamic_change_check(
    int unit,
    int new_threshold,
    soc_reg_t ctr_reg,
    soc_ctr_control_info_t ctrl_info,
