...
#ifndef _BCM_KBP_MEM_TEST_H
#define _BCM_KBP_MEM_TEST_H
...
/* Funtion Prototype modified for HW Eval KBP stress test command */
int kbp_mem_bist_run(int unit, uint32_t kbp_mdio_id, int core, int mode);

#endif /* _BCM_KBP_MEM_TEST_H */
