...
xargs grep -P "$REGEX" |
grep -vP "/unittest/|/tests/|/SAI/|/pyext/|tests.cpp|sai_vs.cpp|sai_proxy.cpp|sai_redis.cpp|saisdkdump|SWSS_LOG|.cpp:\s+\*|.cpp:\s+//|sai_status_t\s+sai_|VendorSai.cpp:.+=\s*&sai_|sai_stub_interfacequery.cpp"
