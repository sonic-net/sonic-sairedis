        ...
        _In_ const sai_service_method_table_t* service_method_table)
{
    ...
    return stub_sai->initialize(flags, service_method_table);
}
...
#define API(api) .api ## _api = const_cast<sai_ ## api ## _api_t*>(&stub_ ## api ## _api)

static sai_apis_t stub_apis = {
    API(switch),
    API(port),
    API(fdb),
    API(vlan),
        ...
        _Out_ void** api_method_table)
{
    ...
    {
        *api_method_table = ((void**)&stub_apis)[sai_api_id - 1];
        ...
        _Out_ sai_attr_capability_t *capability)
{
    ...
    return stub_sai->queryAttributeCapability(
            switch_id,
            object_type,
            attr_id,
            capability);
        ...
        _Inout_ sai_s32_list_t *enum_values_capability)
{
    ...
    return stub_sai->queryAattributeEnumValuesCapability(
            switch_id,
            object_type,
            attr_id,
        ...
        _Out_ uint64_t *count)
{
    ...
    return stub_sai->objectTypeGetAvailability(
            switch_id,
            object_type,
            attr_count,
            attr_list,
        ...
        _In_ sai_object_id_t objectId)
{
    ...
    return stub_sai->objectTypeQuery(objectId);
}
        ...
        _In_ sai_object_id_t objectId)
{
    ...
    return stub_sai->switchIdQuery(objectId);
}
        ...
        _Inout_ sai_stat_capability_list_t *stats_capability)
{
    ...
    return stub_sai->queryStatsCapability(switch_id, object_type, stats_capability);
}
        ...
        _Out_ sai_api_version_t *version)
{
    ...
    return stub_sai->queryApiVersion(version);
}
