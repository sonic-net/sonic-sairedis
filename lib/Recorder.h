...
#define OTAI_REDIS_RECORDER_DECLARE_RECORD_REMOVE(X,ot)   \
    void recordRemove(                                   \
            _In_ const otai_ ## ot ## _t* ot);

#define OTAI_REDIS_RECORDER_DECLARE_RECORD_CREATE(X,ot)  \
    void recordCreate(                                  \
            _In_ const otai_ ## ot ## _t* ot,            \
            _In_ uint32_t attr_count,                   \
            _In_ const otai_attribute_t *attr_list);

#define OTAI_REDIS_RECORDER_DECLARE_RECORD_SET(X,ot)     \
    void recordSet(                                     \
            _In_ const otai_ ## ot ## _t* ot,            \
            _In_ const otai_attribute_t *attr);

#define OTAI_REDIS_RECORDER_DECLARE_RECORD_GET(X,ot)     \
    void recordGet(                                     \
            _In_ const otai_ ## ot ## _t* ot,            \
            _In_ uint32_t attr_count,                   \
            _In_ const otai_attribute_t *attr_list);
...
namespace otairedis
{
    class Recorder
    {
        ...
        public: // create ENTRY
            ...
            OTAIREDIS_DECLARE_EVERY_ENTRY(OTAI_REDIS_RECORDER_DECLARE_RECORD_CREATE);

        public: // remove ENTRY

            OTAIREDIS_DECLARE_EVERY_ENTRY(OTAI_REDIS_RECORDER_DECLARE_RECORD_REMOVE);

        public: // set ENTRY

            OTAIREDIS_DECLARE_EVERY_ENTRY(OTAI_REDIS_RECORDER_DECLARE_RECORD_SET);

        public: // get ENTRY

            OTAIREDIS_DECLARE_EVERY_ENTRY(OTAI_REDIS_RECORDER_DECLARE_RECORD_GET);
        ...
        public: // OTAI query interface API
