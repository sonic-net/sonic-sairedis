                              ...
                              _Inout_ sai_stat_capability_list_t *stats_capability)
{
    ...
    if (objectType == SAI_OBJECT_TYPE_QUEUE)
    {
        ...
        stats_capability->count = 38;
        stats_capability->list[0].stat_enum = SAI_QUEUE_STAT_PACKETS;
        stats_capability->list[1].stat_enum = SAI_QUEUE_STAT_BYTES;
        stats_capability->list[2].stat_enum = SAI_QUEUE_STAT_DROPPED_PACKETS;
        stats_capability->list[3].stat_enum = SAI_QUEUE_STAT_DROPPED_BYTES;
        stats_capability->list[4].stat_enum = SAI_QUEUE_STAT_GREEN_PACKETS;
        stats_capability->list[5].stat_enum = SAI_QUEUE_STAT_GREEN_BYTES;
        stats_capability->list[6].stat_enum = SAI_QUEUE_STAT_GREEN_DROPPED_PACKETS;
        stats_capability->list[7].stat_enum = SAI_QUEUE_STAT_GREEN_DROPPED_BYTES;
        stats_capability->list[8].stat_enum = SAI_QUEUE_STAT_YELLOW_PACKETS;
        stats_capability->list[9].stat_enum = SAI_QUEUE_STAT_YELLOW_BYTES;
        stats_capability->list[10].stat_enum = SAI_QUEUE_STAT_YELLOW_DROPPED_PACKETS;
        stats_capability->list[11].stat_enum = SAI_QUEUE_STAT_YELLOW_DROPPED_BYTES;
        stats_capability->list[12].stat_enum = SAI_QUEUE_STAT_RED_PACKETS;
        stats_capability->list[13].stat_enum = SAI_QUEUE_STAT_RED_BYTES;
        stats_capability->list[14].stat_enum = SAI_QUEUE_STAT_RED_DROPPED_PACKETS;
        stats_capability->list[15].stat_enum = SAI_QUEUE_STAT_RED_DROPPED_BYTES;
        stats_capability->list[16].stat_enum = SAI_QUEUE_STAT_GREEN_WRED_DROPPED_PACKETS;
        stats_capability->list[17].stat_enum = SAI_QUEUE_STAT_GREEN_WRED_DROPPED_BYTES;
        stats_capability->list[18].stat_enum = SAI_QUEUE_STAT_YELLOW_WRED_DROPPED_PACKETS;
        stats_capability->list[19].stat_enum = SAI_QUEUE_STAT_YELLOW_WRED_DROPPED_BYTES;
        stats_capability->list[20].stat_enum = SAI_QUEUE_STAT_RED_WRED_DROPPED_PACKETS;
        stats_capability->list[21].stat_enum = SAI_QUEUE_STAT_RED_WRED_DROPPED_BYTES;
        stats_capability->list[22].stat_enum = SAI_QUEUE_STAT_WRED_DROPPED_PACKETS;
        stats_capability->list[23].stat_enum = SAI_QUEUE_STAT_WRED_DROPPED_BYTES;
        stats_capability->list[24].stat_enum = SAI_QUEUE_STAT_CURR_OCCUPANCY_BYTES;
        stats_capability->list[25].stat_enum = SAI_QUEUE_STAT_WATERMARK_BYTES;
        stats_capability->list[26].stat_enum = SAI_QUEUE_STAT_SHARED_CURR_OCCUPANCY_BYTES;
        stats_capability->list[27].stat_enum = SAI_QUEUE_STAT_SHARED_WATERMARK_BYTES;
        stats_capability->list[28].stat_enum = SAI_QUEUE_STAT_GREEN_WRED_ECN_MARKED_PACKETS;
        stats_capability->list[29].stat_enum = SAI_QUEUE_STAT_GREEN_WRED_ECN_MARKED_BYTES;
        stats_capability->list[30].stat_enum = SAI_QUEUE_STAT_YELLOW_WRED_ECN_MARKED_PACKETS;
        stats_capability->list[31].stat_enum = SAI_QUEUE_STAT_YELLOW_WRED_ECN_MARKED_BYTES;
        stats_capability->list[32].stat_enum = SAI_QUEUE_STAT_RED_WRED_ECN_MARKED_PACKETS;
        stats_capability->list[33].stat_enum = SAI_QUEUE_STAT_RED_WRED_ECN_MARKED_BYTES;
        stats_capability->list[34].stat_enum = SAI_QUEUE_STAT_WRED_ECN_MARKED_PACKETS;
        stats_capability->list[35].stat_enum = SAI_QUEUE_STAT_WRED_ECN_MARKED_BYTES;
        stats_capability->list[36].stat_enum = SAI_QUEUE_STAT_CURR_OCCUPANCY_LEVEL;
        stats_capability->list[37].stat_enum = SAI_QUEUE_STAT_WATERMARK_LEVEL;
