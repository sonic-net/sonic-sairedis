...
//        _In_ const otai_ip_address_t& a,
//        _In_ const otai_ip_address_t& b)
//{
...
//    }
//
//    if (a.addr_family == OTAI_IP_ADDR_FAMILY_IPV4)
//    {
//        return a.addr.ip4 == b.addr.ip4;
//    }
//
//    if (a.addr_family == OTAI_IP_ADDR_FAMILY_IPV6)
//    {
...
//
//static bool operator==(
//        _In_ const otai_ip_prefix_t& a,
//        _In_ const otai_ip_prefix_t& b)
//{
//    if (a.addr_family != b.addr_family)
//    {
//        return false;
...
//
//static bool operator==(
//        _In_ const otai_fdb_entry_t& a,
//        _In_ const otai_fdb_entry_t& b)
//{
//    SWSS_LOG_ENTER();
//
...
//
//static bool operator==(
//        _In_ const otai_mcast_fdb_entry_t& a,
//        _In_ const otai_mcast_fdb_entry_t& b)
//{
//    SWSS_LOG_ENTER();
//
//    return a.switch_id == b.switch_id &&
...
//
//static bool operator==(
//        _In_ const otai_route_entry_t& a,
//        _In_ const otai_route_entry_t& b)
//{
...
//
//    if (a.destination.addr_family == OTAI_IP_ADDR_FAMILY_IPV4)
//    {
//        return part &&
...
//    }
//
//    if (a.destination.addr_family == OTAI_IP_ADDR_FAMILY_IPV6)
//    {
//        return part &&
...
//
//static bool operator==(
//        _In_ const otai_l2mc_entry_t& a,
//        _In_ const otai_l2mc_entry_t& b)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    bool part = a.switch_id == b.switch_id &&
...
//    }
//    else if (a.destination.addr_family == OTAI_IP_ADDR_FAMILY_IPV6)
//    {
...
//    }
//
//    if (a.source.addr_family == OTAI_IP_ADDR_FAMILY_IPV4)
//    {
//        part &= a.source.addr.ip4 == b.source.addr.ip4;
//    }
//    else if (a.source.addr_family == OTAI_IP_ADDR_FAMILY_IPV6)
//    {
...
//
//static bool operator==(
//        _In_ const otai_ipmc_entry_t& a,
//        _In_ const otai_ipmc_entry_t& b)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    bool part = a.switch_id == b.switch_id &&
...
//
//static bool operator==(
//        _In_ const otai_neighbor_entry_t& a,
//        _In_ const otai_neighbor_entry_t& b)
//{
//    SWSS_LOG_ENTER();
//
//    bool part = a.switch_id == b.switch_id &&
...
//
//    if (a.ip_address.addr_family == OTAI_IP_ADDR_FAMILY_IPV4)
//        return part && a.ip_address.addr.ip4 == b.ip_address.addr.ip4;
//
//    if (a.ip_address.addr_family == OTAI_IP_ADDR_FAMILY_IPV6)
...
//
//static bool operator==(
//        _In_ const otai_nat_entry_t& a,
//        _In_ const otai_nat_entry_t& b)
//{
//    SWSS_LOG_ENTER();
//
...
//
//static bool operator==(
//        _In_ const otai_inseg_entry_t& a,
//        _In_ const otai_inseg_entry_t& b)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    return a.switch_id == b.switch_id &&
...
//
//static bool operator==(
//        _In_ const otai_my_sid_entry_t& a,
//        _In_ const otai_my_sid_entry_t& b)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    bool part = a.switch_id == b.switch_id &&
...
//
//static bool operator==(
//        _In_ const otai_direction_lookup_entry_t& a,
//        _In_ const otai_direction_lookup_entry_t& b)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
...
//
//static bool operator==(
//        _In_ const otai_eni_ether_address_map_entry_t& a,
//        _In_ const otai_eni_ether_address_map_entry_t& b)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
...
//
//static bool operator==(
//        _In_ const otai_vip_entry_t& a,
//        _In_ const otai_vip_entry_t& b)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
...
//
//static bool operator==(
//        _In_ const otai_inbound_routing_entry_t& a,
//        _In_ const otai_inbound_routing_entry_t& b)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    return a.switch_id == b.switch_id &&
...
//
//static bool operator==(
//        _In_ const otai_pa_validation_entry_t& a,
//        _In_ const otai_pa_validation_entry_t& b)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
...
//
//static bool operator==(
//        _In_ const otai_outbound_routing_entry_t& a,
//        _In_ const otai_outbound_routing_entry_t& b)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
...
//
//static bool operator==(
//        _In_ const otai_outbound_ca_to_pa_entry_t& a,
//        _In_ const otai_outbound_ca_to_pa_entry_t& b)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
...
//    size_t hash = 0;
//
//    if (prefix.addr_family == OTAI_IP_ADDR_FAMILY_IPV4)
//    {
...
//        return hash;
//    }
//    else if (prefix.addr_family == OTAI_IP_ADDR_FAMILY_IPV6)
//    {
//        uint32_t ip6[4];
...
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_route_entry_t& re)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reason
//
//    if (re.destination.addr_family == OTAI_IP_ADDR_FAMILY_IPV4)
//    {
//        return re.destination.addr.ip4;
//    }
//
//    if (re.destination.addr_family == OTAI_IP_ADDR_FAMILY_IPV6)
//    {
...
//    SWSS_LOG_ENTER();
//
//    if (ne.ip_address.addr_family == OTAI_IP_ADDR_FAMILY_IPV4)
//    {
//        return ne.ip_address.addr.ip4;
//    }
//
//    if (ne.ip_address.addr_family == OTAI_IP_ADDR_FAMILY_IPV6)
//    {
//        // cast is not good enough for arm (cast align)
//        uint32_t ip6[4];
...
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_fdb_entry_t& fe)
//{
//    SWSS_LOG_ENTER();
//
//    uint32_t data;
...
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_nat_entry_t& ne)
//{
//    SWSS_LOG_ENTER();
//
...
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_inseg_entry_t& ie)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    return ie.label;
...
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_my_sid_entry_t& se)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    uint32_t ip6[4];
...
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_mcast_fdb_entry_t& mfe)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    uint32_t data;
...
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_l2mc_entry_t& le)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    if (le.destination.addr_family == OTAI_IP_ADDR_FAMILY_IPV4)
//    {
//        return le.destination.addr.ip4;
//    }
//
//    if (le.destination.addr_family == OTAI_IP_ADDR_FAMILY_IPV6)
//    {
//        // cast is not good enough for arm (cast align)
//        uint32_t ip6[4];
...
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_ipmc_entry_t& ie)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    if (ie.destination.addr_family == OTAI_IP_ADDR_FAMILY_IPV4)
//    {
//        return ie.destination.addr.ip4;
//    }
//
//    if (ie.destination.addr_family == OTAI_IP_ADDR_FAMILY_IPV6)
//    {
//        // cast is not good enough for arm (cast align)
//        uint32_t ip6[4];
...
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_direction_lookup_entry_t& de)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    size_t hash = 0;
...
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_eni_ether_address_map_entry_t & ee)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    std::size_t hash = 0;
...
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_vip_entry_t & ve)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    std::size_t hash = 0;
//
//    boost::hash_combine(hash, otai_get_hash(ve.vip));
//
//    return hash;
//}
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_inbound_routing_entry_t & re)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    size_t hash = 0;
//    boost::hash_combine(hash, otai_get_hash(re.sip));
//    boost::hash_combine(hash, otai_get_hash(re.sip_mask));
...
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_pa_validation_entry_t & pe)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    std::size_t hash = 0;
...
//    boost::hash_combine(hash, otai_get_hash(pe.sip));
//
//    return hash;
//}
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_outbound_routing_entry_t & oe)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    std::size_t hash = 0;
//    boost::hash_combine(hash, otai_get_hash(oe.destination));
...
//
//static inline std::size_t otai_get_hash(
//        _In_ const otai_outbound_ca_to_pa_entry_t & oe)
//{
//    // SWSS_LOG_ENTER(); // disabled for performance reasons
//
//    std::size_t hash = 0;
//    boost::hash_combine(hash, oe.dst_vnet_id);
//    boost::hash_combine(hash, otai_get_hash(oe.dip));
//
//    return hash;
//}
        ...
        _In_ const otai_object_meta_key_t& k) const
{
    ...
    auto meta = otai_metadata_get_object_type_info(k.objecttype);
...
//            return otai_get_hash(k.objectkey.key.route_entry);
//
//        case OTAI_OBJECT_TYPE_NEIGHBOR_ENTRY:
//            return otai_get_hash(k.objectkey.key.neighbor_entry);
//
//        case OTAI_OBJECT_TYPE_FDB_ENTRY:
//            return otai_get_hash(k.objectkey.key.fdb_entry);
//
//        case OTAI_OBJECT_TYPE_NAT_ENTRY:
//            return otai_get_hash(k.objectkey.key.nat_entry);
//
//        case OTAI_OBJECT_TYPE_INSEG_ENTRY:
//            return otai_get_hash(k.objectkey.key.inseg_entry);
//
//        case OTAI_OBJECT_TYPE_MY_SID_ENTRY:
//            return otai_get_hash(k.objectkey.key.my_sid_entry);
//
//        case OTAI_OBJECT_TYPE_MCAST_FDB_ENTRY:
//            return otai_get_hash(k.objectkey.key.mcast_fdb_entry);
//
//        case OTAI_OBJECT_TYPE_L2MC_ENTRY:
//            return otai_get_hash(k.objectkey.key.l2mc_entry);
//
//        case OTAI_OBJECT_TYPE_IPMC_ENTRY:
//            return otai_get_hash(k.objectkey.key.ipmc_entry);
//        default:
//            // Do nothing. Go to extensions
//            break;
//    }

//    switch ((otai_object_type_extensions_t)k.objecttype)
//    {
//        case OTAI_OBJECT_TYPE_DIRECTION_LOOKUP_ENTRY:
//            return otai_get_hash(k.objectkey.key.direction_lookup_entry);
//
//        case OTAI_OBJECT_TYPE_ENI_ETHER_ADDRESS_MAP_ENTRY:
//            return otai_get_hash(k.objectkey.key.eni_ether_address_map_entry);
//
//        case OTAI_OBJECT_TYPE_VIP_ENTRY:
//            return otai_get_hash(k.objectkey.key.vip_entry);
//
//        case OTAI_OBJECT_TYPE_INBOUND_ROUTING_ENTRY:
//            return otai_get_hash(k.objectkey.key.inbound_routing_entry);
//
//        case OTAI_OBJECT_TYPE_PA_VALIDATION_ENTRY:
//            return otai_get_hash(k.objectkey.key.pa_validation_entry);
//
//        case OTAI_OBJECT_TYPE_OUTBOUND_ROUTING_ENTRY:
//            return otai_get_hash(k.objectkey.key.outbound_routing_entry);
//
//        case OTAI_OBJECT_TYPE_OUTBOUND_CA_TO_PA_ENTRY:
//            return otai_get_hash(k.objectkey.key.outbound_ca_to_pa_entry);
//
//        default:
//            SWSS_LOG_THROW("not handled: %s", otai_serialize_object_type(k.objecttype).c_str());
//    }
