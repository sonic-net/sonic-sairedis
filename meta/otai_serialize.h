...
//        _In_ const otai_ip_address_t &ip_address);

//std::string otai_serialize_ip_prefix(
//        _In_ const otai_ip_prefix_t &ip_prefix);
...
//        _In_ const otai_vlan_id_t vlan_id);
...
//        _In_ const otai_twamp_session_stat_t counter);

//std::string otai_serialize_poe_port_power_consumption(
//        _In_ const otai_poe_port_power_consumption_t& pppc);
...
//        _In_ const std::string& s,
//        _In_ otai_fdb_entry_t &fdb_entry);

//void otai_deserialize_neighbor_entry(
//        _In_ const std::string& s,
//        _In_ otai_neighbor_entry_t &neighbor_entry);

//void otai_deserialize_route_entry(
//        _In_ const std::string& s,
//        _In_ otai_route_entry_t &route_entry);
...
//        _In_ const std::string& s,
//        _In_ otai_nat_entry_t &nat_entry);

//void otai_deserialize_inseg_entry(
//        _In_ const std::string& s,
//        _In_ otai_inseg_entry_t &inseg_entry);

//void otai_deserialize_l2mc_entry(
//        _In_ const std::string& s,
//        _In_ otai_l2mc_entry_t &l2mc_entry);

//void otai_deserialize_ipmc_entry(
//        _In_ const std::string& s,
//        _In_ otai_ipmc_entry_t &ipmc_entry);

//void otai_deserialize_mcast_fdb_entry(
//        _In_ const std::string& s,
//        _In_ otai_mcast_fdb_entry_t &mcast_fdb_entry);
...
//        _In_ const std::string& s,
//        _Out_ otai_my_sid_entry_t& my_sid_entry);
...
//        _In_ const std::string& s,
//        _Out_ otai_poe_port_power_consumption_t& pppc);
...
//        _Out_ otai_fdb_event_notification_data_t** fdbdata);

//void otai_deserialize_nat_event_ntf(
//        _In_ const std::string& s,
//        _Out_ uint32_t &count,
//        _Out_ otai_nat_event_notification_data_t** natdata);

//void otai_deserialize_port_oper_status_ntf(
//        _In_ const std::string& s,
//        _Out_ uint32_t &count,
//        _Out_ otai_port_oper_status_notification_t** portoperstatus);
...
//        _In_ const std::string& s,
//        _Out_ uint32_t &count,
//        _Out_ otai_bfd_session_state_notification_t** bfdsession);
...
//        _In_ uint32_t count,
//        _In_ otai_fdb_event_notification_data_t* fdbdata);

//void otai_deserialize_free_nat_event_ntf(
//        _In_ uint32_t count,
//        _In_ otai_nat_event_notification_data_t* natdata);

//void otai_deserialize_free_port_oper_status_ntf(
//        _In_ uint32_t count,
//        _In_ otai_port_oper_status_notification_t* portoperstatus);

//void otai_deserialize_free_queue_deadlock_ntf(
//        _In_ uint32_t count,
//        _In_ otai_queue_deadlock_notification_data_t* deadlock_data);

//void otai_deserialize_free_bfd_session_state_ntf(
//        _In_ uint32_t count,
//        _In_ otai_bfd_session_state_notification_t* bfdsessionstate);
