...
#define ATTR_MAP_SET(x,y) map[(int32_t)SAI_OBJECT_TYPE_ ## x][(int32_t)y] = # y
    ...
    ATTR_MAP_SET(ACL_ENTRY,SAI_ACL_ENTRY_ATTR_ADMIN_STATE);
...
*/
    ...
    ATTR_MAP_SET(PORT,SAI_PORT_ATTR_INGRESS_ACL_LIST);
    ...
    ATTR_MAP_SET(SWITCH,SAI_SWITCH_ATTR_DEFAULT_INGRESS_ACL_LIST);
