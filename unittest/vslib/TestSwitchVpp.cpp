...
TEST(SwitchVpp, getLagMemberEffectiveAdminUp)
{
    EXPECT_TRUE(SwitchVpp::getLagMemberEffectiveAdminUp(true, false));
    EXPECT_FALSE(SwitchVpp::getLagMemberEffectiveAdminUp(true, true));
    EXPECT_FALSE(SwitchVpp::getLagMemberEffectiveAdminUp(false, false));
    EXPECT_FALSE(SwitchVpp::getLagMemberEffectiveAdminUp(false, true));
}
