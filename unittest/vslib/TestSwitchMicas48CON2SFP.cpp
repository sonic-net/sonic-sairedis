...
static std::shared_ptr<SwitchMicas48CON2SFP> createMicasSwitch(bool useTapDevice = false)
{
    SWSS_LOG_ENTER();
    ...
    sc->m_switchType = SAI_VS_SWITCH_TYPE_MICAS_48CON2SFP;
    ...
    auto sw = std::make_shared<SwitchMicas48CON2SFP>(
            0x2100000000,
...
TEST(SwitchMicas48CON2SFP, ctr)
{
    ...
    SwitchMicas48CON2SFP sw(
            0x2100000000,
            std::make_shared<RealObjectIdManager>(0, scc),
            sc);

    SwitchMicas48CON2SFP sw2(
            0x2100000000,
            std::make_shared<RealObjectIdManager>(0, scc),
            sc,
            nullptr);
...
TEST(SwitchMicas48CON2SFP, switchQueueNumberGet)
{
    auto sc = std::make_shared<SwitchConfig>(0, "");
    auto signal = std::make_shared<Signal>();
    auto eventQueue = std::make_shared<EventQueue>(signal);
...
TEST(SwitchMicas48CON2SFP, refresh_bridge_port_list)
{
    auto sc = std::make_shared<SwitchConfig>(0, "");
    auto signal = std::make_shared<Signal>();
    auto eventQueue = std::make_shared<EventQueue>(signal);
...
TEST(SwitchMicas48CON2SFP, vs_create_hostif_tap_genetlink)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_create_hostif_tap_missing_type)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_create_hostif_tap_unsupported_type)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_create_hostif_tap_netdev_missing_obj_id)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_create_hostif_tap_netdev_no_interface)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_remove_hostif_tap_nonexistent)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, restoreBackingInterfaces_no_ethernet)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, hostif_create_tap_veth_forwarding)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, warm_update_queues)
{
    auto sc = std::make_shared<SwitchConfig>(0, "");
    auto signal = std::make_shared<Signal>();
    auto eventQueue = std::make_shared<EventQueue>(signal);
...
TEST(SwitchMicas48CON2SFP, setPort_non_autoneg)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, setPort_autoneg_no_tap)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_create_hostif_tap_vlan_obj)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_create_hostif_tap_non_port_obj)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_create_hostif_tap_missing_name)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_create_hostif_tap_long_name)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_create_hostif_tap_netdev_bad_name)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_remove_hostif_tap_genetlink)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_remove_hostif_tap_vlan)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, renameNetIntf_nonexistent)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, create_qos_queues_per_port_verify)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_create_hostif_tap_interface_lo)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_create_hostif_tap_interface_lo_with_callback)
{
    auto sw = createMicasSwitch(false);
...
TEST(SwitchMicas48CON2SFP, vs_remove_hostif_tap_full_path)
{
    auto sw = createMicasSwitch(false);
